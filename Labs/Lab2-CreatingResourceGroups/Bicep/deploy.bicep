...
param rgInfra string = 'RG-BTC-${uniqueName}-${workloadNameInfra}-${location}-${localEnv}'
//CODE: Make the rgInfra parameter upper case

//CODE: Create the rgVM parameter in the same manner as rgInfra
...
//CODE: Create the VM Resource Group in the same manner as the Infra Resource Group
