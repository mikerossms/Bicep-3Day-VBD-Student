...
//Pull the actual keyvaul resource in so we can reference

//CODE: Use the "existing" resource type to pull in the keyvault you just created

//Finally lets deploy a VM
module vm 'Modules/singlevm.bicep' = {
  name: 'SingleVM'
  ...
  params: {
    ...
    adminPassword: //CODE: Use the getSecret function to get your local admin password from the vault.
