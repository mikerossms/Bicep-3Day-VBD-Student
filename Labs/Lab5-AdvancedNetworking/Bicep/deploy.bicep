...
//CODE:  Add the "existingFirewall" resource.  You will need just the firewallName and the firewallRG
//CODE:  The resource to use is 'Microsoft.Network/azureFirewalls@2023-09-01'
...
var firewallIP = existingFirewall.properties. //CODE: fill in the rest.  Remember a firewall can have more than 1 ip address
